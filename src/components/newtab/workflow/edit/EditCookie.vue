<template>
  <div>
    ...
    <template v-if="permission.has.cookies">
      ...
      <template v-if="data.useJson">
        ...
        <a
          ...
          target="_blank"
        >
          {{ t('workflow.edit.cookie.seeAllProperties') }}
        </a>
      </template>
      <template v-else>
        <ui-input
        ...
        <ui-input
          ...
          :label="
            data.type === 'get' && !data.getAll
              ? t('common.name')
              : t('workflow.edit.cookie.nameOptional')
          "
          class="mt-2 w-full"
        ...
        <ui-input
          ...
          :label="t('workflow.edit.cookie.valueOptional')"
          class="mt-2 w-full"
          placeholder="value"
        ...
        <ui-input
          ...
          class="mt-2 w-full"
          :label="t('workflow.edit.cookie.pathOptional')"
          placeholder="/"
        ...
        <ui-input
          ...
          class="mt-2 w-full"
          :label="t('workflow.edit.cookie.domainOptional')"
        ...
        <ui-input
          ...
          class="mt-2 w-full"
          :label="t('workflow.edit.cookie.sameSiteOptional')"
          placeholder="lax"
        ...
        <ui-input
          ...
          class="mt-2 w-full"
          :label="t('workflow.edit.cookie.expirationDateOptional')"
          placeholder="3600"
    ...
    <template v-else>
      <p class="mt-4">
        {{ t('workflow.edit.cookie.requirePermission') }}
      </p>
