export const tasks = {
  ...
  'ai-chat': {
    name: 'AI chat',
    description: 'Chat with an OpenAI-compatible LLM',
    icon: 'riMagicLine',
    component: 'BlockBasic',
    editComponent: 'EditAiChat',
    category: 'general',
    inputs: 1,
    outputs: 1,
    allowedInputs: true,
  ...
  'python-code': {
    name: 'Python code',
    description: 'Execute your custom python code',
    icon: 'riCodeBoxLine',
    component: 'BlockBasic',
    editComponent: 'EditPythonCode',
    category: 'general',
    inputs: 1,
    outputs: 1,
    allowedInputs: true,
